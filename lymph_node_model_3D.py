...
def deep_learning(true_images,false_images,labels):
    ...
    model.add(Conv3D(16, (3, 3,3), activation='relu', padding='same', kernel_regularizer = regularizers.l2(0.001)))
    model.add(MaxPooling3D(pool_size=(2,2,2)))

    #model.add(Conv3D(32, (3,3,3), activation='relu',padding='same', kernel_regularizer = regularizers.l1(0.001)))
    #model.add(MaxPooling3D(pool_size = (2,2,2)))
    model.add(Flatten())
